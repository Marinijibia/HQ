  ...
  const loadFallbackMessages = () => {
    setMessages([
      ...
      },
      {
        ...
        senderName: 'Asad',
        senderTitle: 'Chief Executive Officer (CEO)',
        content:
      ...
      },
      {
        ...
        content:
          'Operations telemetry ready. We can deploy automated fleet tracking sub-agents to monitor real-time corridor throughput and latency.',
        timestamp: '10:02 AM',
      },
      {
        id: 'msg-4',
        senderId: 'exec-intel',
        senderType: 'EXECUTIVE',
        senderName: 'Mr. Intelligence',
        senderTitle: 'Public Search & Research Agent',
        content:
          'Live web signals indexed. Domain indicators and regional market sentiment across key trade hubs indicate high strategic growth momentum.',
        timestamp: '10:03 AM',
      },
    ]);
  };
