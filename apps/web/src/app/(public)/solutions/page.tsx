  ...
  return (
    <div className="py-12 max-w-6xl mx-auto px-6 space-y-16">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        <Card className="p-7 space-y-4 border border-[#1E1E24]/60 bg-black/40 backdrop-blur-md">
          <div className="flex items-center space-x-3">
            ...
            <h3 className="text-lg font-bold text-white">Technology & SaaS</h3>
          </div>
        ...
        <Card className="p-7 space-y-4 border border-[#1E1E24]/60 bg-black/40 backdrop-blur-md">
          <div className="flex items-center space-x-3">
            ...
            <h3 className="text-lg font-bold text-white">Energy & Petroleum</h3>
          </div>
          <p className="text-xs text-foreground/50 leading-relaxed">
        ...
        <Card className="p-7 space-y-4 border border-[#1E1E24]/60 bg-black/40 backdrop-blur-md">
          <div className="flex items-center space-x-3">
            ...
            <h3 className="text-lg font-bold text-white">Venture & Finance</h3>
          </div>
          <p className="text-xs text-foreground/50 leading-relaxed">
        ...
        <Card className="p-7 space-y-4 border border-[#1E1E24]/60 bg-black/40 backdrop-blur-md">
          <div className="flex items-center space-x-3">
            ...
            <h3 className="text-lg font-bold text-white">Consulting & Agency</h3>
          </div>
          <p className="text-xs text-foreground/50 leading-relaxed">
