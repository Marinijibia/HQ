...
export default function TermsPage() {
  return (
    <div className="py-12 max-w-3xl mx-auto px-6 space-y-8 text-left select-none">
      ...
      <Card className="p-6 border border-[#1E1E24]/60 bg-black/40 backdrop-blur-md text-xs text-foreground/50 leading-relaxed space-y-4 font-normal">
        <h2 className="text-sm font-bold text-white">1. Service Definition</h2>
        <p>
          HQ provides an intelligent executive Operating System to plan, orchestrate, and audit
          operations autonomously.
        </p>

        <h2 className="text-sm font-bold text-white">2. Rate Limits & Subscriptions</h2>
        <p>
        ...
        <h2 className="text-sm font-bold text-white">3. Data Ownership</h2>
        <p>
