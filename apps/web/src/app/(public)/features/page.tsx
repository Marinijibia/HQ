    ...
    <div className="py-12 max-w-6xl mx-auto px-6 space-y-16">
      ...
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        <Card className="p-6 space-y-4 border border-[#1E1E24]/60 bg-black/40 backdrop-blur-md">
          ...
          <h3 className="text-base font-bold text-white">WBS Graph Generation</h3>
        ...
        <Card className="p-6 space-y-4 border border-[#1E1E24]/60 bg-black/40 backdrop-blur-md">
          ...
          <h3 className="text-base font-bold text-white">Hierarchical RAG Memory</h3>
          <p className="text-xs text-foreground/50 leading-relaxed">
        ...
        <Card className="p-6 space-y-4 border border-[#1E1E24]/60 bg-black/40 backdrop-blur-md">
          ...
          <h3 className="text-base font-bold text-white">Self-Evaluation Gate</h3>
          <p className="text-xs text-foreground/50 leading-relaxed">
      ...
      <div className="border border-[#1E1E24]/60 bg-[#0A0A0C]/50 rounded-2xl p-8 relative overflow-hidden">
