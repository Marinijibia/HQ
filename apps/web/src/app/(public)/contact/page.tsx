  ...
  return (
    <div className="py-12 max-w-4xl mx-auto px-6 space-y-16">
      ...
      <div className="grid gap-8 md:grid-cols-2 text-left">
        ...
        {/* Contact Form */}
        <Card className="p-6 border border-[#1E1E24]/60 bg-black/40 backdrop-blur-md">
          {success ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-xs">
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  required
                  className="h-24 w-full rounded-md border border-[#1E1E24] bg-[#0A0A0C] px-3 py-2 text-sm text-white focus:outline-none"
                />
              </div>
