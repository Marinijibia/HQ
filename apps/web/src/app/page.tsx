    ...
    <div className="min-h-screen bg-[#030303] text-[#F2F2F7] flex flex-col justify-between font-sans relative overflow-hidden select-none">
      ...
      <section className="flex-1 flex flex-col items-center justify-center px-6 text-center py-24 relative z-10">
        <div className="max-w-4xl space-y-8">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-white leading-[1.1] max-w-3xl mx-auto">
            Collaborate with an{' '}
          ...
          <div className="flex flex-col sm:flex-row gap-4.5 justify-center pt-6">
            ...
            <Link href="/boardroom">
              <Button
                size="lg"
                variant="outline"
                className="flex items-center gap-1.5 font-bold px-6 h-11 border-[#1E1E24] text-foreground/80 hover:text-white hover:bg-[#1E1E24]/20 transition-all"
              >
                Meet the Board
      ...
      <section className="px-6 py-24 sm:px-12 border-t border-[#1E1E24]/50 bg-gradient-to-b from-[#0A0A0C]/50 to-transparent relative z-10">
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <Card className="p-7 space-y-5 border border-[#1E1E24]/60 bg-black/40 backdrop-blur-md hover:border-hq-blue/40 transition-all hover:translate-y-[-4px] duration-300">
              ...
              <div className="space-y-2">
                <h3 className="text-base font-bold text-white">25 C-Suite Specialists</h3>
            ...
            <Card className="p-7 space-y-5 border border-[#1E1E24]/60 bg-black/40 backdrop-blur-md hover:border-hq-purple/40 transition-all hover:translate-y-[-4px] duration-300">
              ...
              <div className="space-y-2">
                <h3 className="text-base font-bold text-white">DAG Task Orchestration</h3>
                <p className="text-xs text-foreground/50 leading-relaxed">
            ...
            <Card className="p-7 space-y-5 border border-[#1E1E24]/60 bg-black/40 backdrop-blur-md hover:border-hq-cyan/40 transition-all hover:translate-y-[-4px] duration-300">
              ...
              <div className="space-y-2">
                <h3 className="text-base font-bold text-white">Zero-Trust Boundaries</h3>
                <p className="text-xs text-foreground/50 leading-relaxed">
