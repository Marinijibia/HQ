...
export default function BoardroomPage() {
  ...
  const [executives, setExecutives] = React.useState<BoardExecutive[]>([
    ...
    },
    {
      ...
      status: 'Available',
      currentTask: 'Auditing regulatory policies, data protection, and terms',
      alignment: 99,
    },
    {
      id: 'exec-hr',
      ...
      status: 'Available',
      currentTask: 'Managing team roles, workspace permissions, and onboarding',
      alignment: 97,
    },
    {
      id: 'exec-research',
      ...
      status: 'Researching',
      currentTask: 'Indexing live market signals and domain benchmarks',
      alignment: 98,
    },
  ]);
