        ...
        {activeTab === 'overview' && (
          <div className="grid gap-6 lg:grid-cols-3 text-left">
            <div className="lg:col-span-2 space-y-6">
              ...
              {/* Emergency Controls */}
              <Card className="border border-red-500/20 bg-red-500/5 p-5 shadow-[var(--card-shadow)] space-y-4">
                <div>
                    ...
                    {requests.map(req => (
                      <div key={req.id} className="flex items-center justify-between p-3 rounded-lg border border-card-border bg-[#F9F9FB] dark:bg-[#0A0A0C]/20 text-xs">
                        ...
                        <div className="flex gap-1.5 shrink-0">
                          <button onClick={() => handleAction(req.id, 'Approved')} className="text-green-500 hover:text-green-600 font-extrabold text-[10.5px]">Approve</button>
                          <button onClick={() => handleAction(req.id, 'Rejected')} className="text-red-500 hover:text-red-600 font-extrabold text-[10.5px]">Reject</button>
                        </div>
                      </div>
                    ))}
                  </div>
                  ...
                  {models.map(m => (
                    <div key={m.id} className="flex items-center justify-between text-xs">
                      ...
                      <button
                        ...
                        className={`text-[9.5px] px-2 py-0.5 rounded font-black uppercase transition-all ${
                          m.enabled
        ...
        {activeTab === 'studio' && (
          <div className="grid gap-6 md:grid-cols-3 text-left">
            <div className="md:col-span-2 space-y-6">
                ...
                <div className="space-y-3.5 text-xs font-semibold">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      size="sm"
                      variant="outline"
                      className="text-xs border-card-border font-bold h-8.5 text-hq-cyan"
              ...
              {simulationResult && (
                <Card className="border border-hq-cyan/40 bg-hq-cyan/5 p-4 shadow-[var(--card-shadow)] text-xs">
                    ...
                    {delegations.map(del => (
                      <div key={del.id} className="p-3 rounded-lg border border-card-border bg-[#F9F9FB] dark:bg-[#0A0A0C]/20 text-xs flex justify-between gap-4">
                        ...
                        <div className="flex gap-2.5 shrink-0 self-center">
                          ...
                          <button onClick={() => handleRevokeDelegation(del.id)} className="text-red-500 hover:text-red-600 font-extrabold text-[10.5px]">Revoke</button>
                        </div>
                      </div>
                    ))}
                  </div>
            ...
            <div className="space-y-3">
              {filteredDecisions.length === 0 ? (
                ...
                filteredDecisions.map(dec => (
                  <Card key={dec.id} className="border border-card-border bg-card-bg p-4 shadow-[var(--card-shadow)] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
