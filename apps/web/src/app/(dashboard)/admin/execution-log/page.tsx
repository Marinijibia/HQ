          ...
          <div className="grid gap-6 md:grid-cols-3 text-left">
            <div className="md:col-span-2 space-y-6">
              ...
              <Card className="border border-card-border bg-card-bg p-5 shadow-[var(--card-shadow)] flex items-center justify-between gap-4">
                ...
                <Button variant="outline" size="sm" className="text-xs border-card-border" onClick={handleGC}>
                  Clear Context Cache
                </Button>
              </Card>
            </div>
        ...
        {activeTab === 'events' && (
          <div className="text-left space-y-4">
            ...
            <div className="space-y-3">
              {events.map(ev => (
                <div key={ev.id} className="p-3.5 rounded-lg border border-card-border bg-card-bg shadow-[var(--card-shadow)] flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-xs">
