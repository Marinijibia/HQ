            ...
            {filteredOrgs.length > 0 ? (
              filteredOrgs.map((org) => (
                <tr key={org.id} className="hover:bg-white/5 transition-colors">
                  <td className="p-4">
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 rounded-xl bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 flex items-center justify-center font-bold text-xs">
                  ...
                  <td className="p-4">
                    <span className="px-2.5 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/30 text-cyan-300 text-[10px] font-black uppercase tracking-wider">
                  ...
                  <td className="p-4 text-right">
                    <Button
                      ...
                      className="bg-cyan-500/10 hover:bg-cyan-500/20 border border-cyan-500/30 text-cyan-300 font-bold text-xs px-3.5 py-1.5 rounded-xl transition-all"
                    >
                      Inspect & Manage
                    </Button>
                  </td>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-md p-4 animate-fadeIn">
          <div className="bg-white dark:bg-[#0B0F19] border border-slate-200 dark:border-white/10 rounded-3xl w-full max-w-md p-6 space-y-5 text-slate-900 dark:text-white shadow-2xl">
            ...
            <div className="space-y-4 text-xs">
              ...
              <div className="p-3 rounded-xl bg-cyan-500/10 border border-cyan-500/30 text-cyan-300 text-[11px] leading-relaxed">
                Will be automatically provisioned with the <strong>5 Core Active Executives</strong> (**Asad**, **Teema**, **Legal**, **Resource Director**, **Mr. Intelligence**).
              </div>
            </div>
