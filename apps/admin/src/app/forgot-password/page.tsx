      ...
      <header className="flex h-16 items-center justify-between border-b border-rose-500/20 px-6 sm:px-12 bg-black/40 backdrop-blur-xl relative z-10">
        <div className="flex items-center space-x-2.5">
          ...
          <span className="font-extrabold tracking-tight text-foreground text-sm flex items-center gap-1.5">
            HQ <span className="text-rose-500 text-xs font-bold font-mono hidden sm:inline">| Admin Recovery Gateway</span>
          </span>
        </div>
            ...
            <CardContent className="space-y-4 pt-2">
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-1.5">
                  <label className="text-[11px] font-bold uppercase tracking-wider text-slate-300">Staff Email Address</label>
                  <Input
                    type="email"
                    ...
                    required
                    className="bg-black/50 border-rose-500/20 text-white h-11 text-xs focus-visible:ring-rose-500 rounded-xl placeholder:text-slate-600"
                  />
                </div>
