    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#06080D] text-foreground flex items-center justify-center p-6 animate-in fade-in duration-300 select-none">
      <Card className="max-w-md w-full border border-rose-500/20 bg-white/90 dark:bg-[#0B0F19]/90 backdrop-blur-2xl p-8 rounded-3xl shadow-2xl text-center space-y-6">
        ...
        <div className="grid grid-cols-2 gap-2 text-left pt-2">
          <Link href="/dashboard">
            <Card className="p-3 border border-slate-200 dark:border-white/10 hover:border-cyan-500/40 bg-slate-50 dark:bg-white/[0.02] transition-all flex items-center gap-2 cursor-pointer">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-500 dark:text-slate-400">Main Center</p>
              </div>
            </Card>
          </Link>
          <Link href="/dashboard/compliance">
            <Card className="p-3 border border-slate-200 dark:border-white/10 hover:border-cyan-500/40 bg-slate-50 dark:bg-white/[0.02] transition-all flex items-center gap-2 cursor-pointer">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-500 dark:text-slate-400">Policies</p>
              </div>
            </Card>
          </Link>
          <Link href="/dashboard/execution-log">
            <Card className="p-3 border border-slate-200 dark:border-white/10 hover:border-cyan-500/40 bg-slate-50 dark:bg-white/[0.02] transition-all flex items-center gap-2 cursor-pointer">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-500 dark:text-slate-400">Kernel Traces</p>
              </div>
            </Card>
          </Link>
          <Link href="/dashboard/white-label">
            <Card className="p-3 border border-slate-200 dark:border-white/10 hover:border-cyan-500/40 bg-slate-50 dark:bg-white/[0.02] transition-all flex items-center gap-2 cursor-pointer">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-500 dark:text-slate-400">White-labeling</p>
              </div>
            </Card>
          </Link>
        </div>
        ...
        <div className="pt-2">
          <Link href="/dashboard">
            <Button className="w-full bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white font-bold text-xs h-11 rounded-xl shadow-md flex items-center justify-center gap-2">
